...
Here's an example of memory usage during and after loading the 60GB FLUX.2-dev BF16 model along with the FP8 version of the Mistral 3 text encoder which is 17GB. As you can see, model loading happens extremely fast and memory usage never goes over 60%:
